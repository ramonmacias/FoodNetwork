 ...
 */
public class DistrictRankingAdapter extends ArrayAdapter<String> {

    private final List<String> values;
    private final Context context;
    private List<RankingDTO> valuesDTO;

    public DistrictRankingAdapter(Context context, List<String> values, List<RankingDTO> valuesDTO){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        textView.setText(valuesDTO.get(position).getDistrict());

        String firstLetter = String.valueOf(valuesDTO.get(position).getDistrict().charAt(0)).toUpperCase();
