 ...
 */
public class UserRankingAdapter extends ArrayAdapter<String> {

    private final List<String> values;
    private final Context context;
    private final List<UserDTO> valuesDTO;

    public UserRankingAdapter(Context context, List<String> values, List<UserDTO> valuesDTO){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        textView.setText(valuesDTO.get(position).getName() + " " + valuesDTO.get(position).getLastName());

        String firstLetter = String.valueOf(valuesDTO.get(position).getName().charAt(0)).toUpperCase();
